...
load("@npm//proto:protobufjs-cli/package_json.bzl", "bin")
...
def ts_proto_library(name, proto, deps = [], **kwargs):
    ...
    bin.pbjs(
        ...
        args = [
            ...
            "--wrap=es6",
            "--root=%s" % name,
            # ../../../ is needed since bin.pbjs runs within bazel-out/XXX/bin
            "--out=../../../$@",
    ...
    bin.pbts(
        ...
        args = [
            # ../../../ is needed since bin.pbts runs within bazel-out/XXX/bin
            "--out=../../../$@",
            "../../../$(location %s)" % js_target,
        ],
        outs = [ts_out],
    )
    ...
    js_library(
        ...
        deps = deps + [
            "//proto:node_modules/protobufjs",
            "//proto:node_modules/long",
        ],
        **kwargs
    )
